...
test('both V28 release artifacts are reproducible from the manifest', () => {
  const expected = buildFromManifest();
  for (const file of [
    path.join(root, 'giao-dien-desktop-don-gian_v28_quan.html'),
    path.join(root, '..', 'BANDIAO', 'giao-dien-desktop-don-gian_v28_quan.html')
  ]) {
