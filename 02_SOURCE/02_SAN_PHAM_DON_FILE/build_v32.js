...
const defaultModulesDir = path.join(__dirname, 'VERSIONS', 'MODULES_V32');
const defaultOutputPath = path.join(__dirname, 'STAGING', 'giao-dien-desktop-don-gian_v32_quan.html');
...
function buildBundle(options = {}) {
    ...
    output = output.replace(
        ...
        (_match, openTag, closeTag) => `${openTag}v32${closeTag}`
    );
...
if (require.main === module) {
    ...
    console.log(`Built v32 staging: ${result.outputPath}`);
