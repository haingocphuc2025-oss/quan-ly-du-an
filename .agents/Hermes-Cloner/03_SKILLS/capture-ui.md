...
Chụp ma trận màn hình và trạng thái.
...
`SCREENSHOT_INDEX.md + references/`
...
`Dùng /capture-ui, tạo SCREENSHOT_INDEX.md + references/, rồi dừng để workflow đánh giá bước tiếp theo.`
